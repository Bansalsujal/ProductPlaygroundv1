...
**Instructions**: Respond as a real interviewer would. Keep responses under 50 words. Be direct and conversational.`;
      ...
      const assistantMessage = {
        role: 'Product Case Interviewer',
        message: typeof aiResponse === 'object' && aiResponse !== null ? (aiResponse.message || aiResponse.response || aiResponse.text || JSON.stringify(aiResponse)) : (aiResponse || "I'm thinking about your response..."),
        timestamp: new Date().toISOString()
      };
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 text-left max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-700 leading-relaxed">{currentQuestion.title}</p>
                  </div>
                </div>
